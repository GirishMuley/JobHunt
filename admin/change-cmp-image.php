<?php 
   ...
   $query=mysqli_query($con,"update tblcompany set cmpImage='$imgnewfile' where id='$postid'");
   if($query)
   {
            ...
            <div class="content">
               <div class="container">
                  ...
                  <form name="addpost" method="post" enctype="multipart/form-data">
                     <?php
                        $postid=intval($_GET['pid']);
                        $query=mysqli_query($con,"select cmpImage,cmpLink from tblcompany where id='$postid' and Is_Active=1 ");
                  ...
                  <input type="file" class="form-control" id="cmpimages" name="cmpimages"  required>
                  </div>
                  </div>
                  </div>
