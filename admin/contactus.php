<?php 
   ...
   $query=mysqli_query($con,"update tblpages set PageTitle='$pagetitle',Description='$pagedetails' where PagesName='$pagetype' ");
   if($query)
   {
...
<html lang="en">
   <head>
      ...
      <!-- App title -->
      <title>Job hunt | Contact us Page</title>
      <!-- Summernote css -->
         ...
         <div class="content-page">
            ...
            <div class="content">
               <div class="container">
                  ...
                  <?php 
                     $pagetype='contactus';
                     $query=mysqli_query($con,"select PageTitle,Description from tblpages where PagesName='$pagetype'");
