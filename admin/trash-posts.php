...
<html lang="en">
   <head>
      ...
      <!-- App title -->
      <title>Job Hunt | Manage Posts</title>
      <!--Morris Chart CSS -->
                        ...
                        <div class="card-box">
                           <div class="table-responsive">
                              <table class="table table-colored table-centered table-inverse m-0">
                                 ...
                                 <tbody>
                                    <?php
                                       $query=mysqli_query($con,"SELECT tblposts.id as postid,tblposts.posttitle as title,tblposts.postcategory as category,tblposts.postsubcategory as subcategory FROM `tblposts` WHERE Is_Active='0'");
