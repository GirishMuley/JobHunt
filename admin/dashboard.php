                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                           <div class="card-box widget-box-one">
                              ...
                              <div class="wigdet-one-content">
                                 <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Companys Listed</p>
                                 <?php $query=mysqli_query($con,"select * from tblcompany where Is_Active=1");
                     ...
                     <a href="user-list.php">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                           <div class="card-box widget-box-one">
                              ...
                              <div class="wigdet-one-content">
                                 <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Users list</p>
                                 <?php $query=mysqli_query($con,"select * from userinfodb where Is_Active=1");
                                    $countposts=mysqli_num_rows($query);
                                    ?>
                                 <h2><?php echo htmlentities($countposts);?> <small></small></h2>
                              </div>
                     ...
                     <a href="feedback-list.php">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                           <div class="card-box widget-box-one">
                              <i class="mdi mdi-layers widget-one-icon"></i>
                              <div class="wigdet-one-content">
                                 <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Feedback Listed</p>
                                 <?php $query=mysqli_query($con,"select * from tblfeedback where Is_Active=1");
                                    $countposts=mysqli_num_rows($query);
                                    ?>
                                 <h2><?php echo htmlentities($countposts);?> <small></small></h2>
                              </div>
