                        ...
                        <div class="card-box">
                           <div class="table-responsive">
                              <table class="table table-colored table-centered table-inverse m-0">
                                 ...
                                 <tbody>
                                    <?php
                                       $query=mysqli_query($con,"SELECT tblposts.id as postid,posttitle,postcategory,postsubcategory FROM `tblposts` WHERE Is_Active='1'");
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo htmlentities($row['postsubcategory'])?></td>
